        ...
        <div class=" hidden md:block col-span-1">
            ...
            <div class="mt-5 flex flex-col">
                @foreach ($kategori as $kate)
                    <a href="/kategori/{{ $kate->slug }}" class="border-b border-solid p-2 mr-3 hover:bg-gray-200">{{ $kate->categories }}</a>
                @endforeach

            </div>
        </div>
        <div class="col-span-3">
            <div class="text-left w-full md:w-auto font-bold mt-10"><span>{{ $kategori_nama->categories }}</span></div>
